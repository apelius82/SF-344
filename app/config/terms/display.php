...
return [
    ...
    'playlist_modal_title' => [
        'fi' => 'Infonäyttöjen ajolistat',
        'sv' => 'Infoskärmarnas spellistor',
        'en' => 'Display playlists',
        'it' => 'Playlist dei display',
        'el' => 'Λίστες αναπαραγωγής οθονών',
    ],
    'playlist_modal_description' => [
        'fi' => 'Valitse infonäyttö nähdäksesi, miten tämä SafetyFlash näkyy kyseisen näytön ajolistassa.',
        'sv' => 'Välj infoskärm för att se hur denna SafetyFlash visas i skärmens spellista.',
        'en' => 'Select a display to see how this SafetyFlash appears in that display playlist.',
        'it' => 'Seleziona un display per vedere come questo SafetyFlash appare nella playlist del display.',
        'el' => 'Επιλέξτε οθόνη για να δείτε πώς εμφανίζεται αυτό το SafetyFlash στη λίστα αναπαραγωγής της.',
    ],
    'label_select_display' => [
        'fi' => 'Näyttö',
        'sv' => 'Skärm',
        'en' => 'Display',
        'it' => 'Display',
    ...
    'label_select_display_playlist' => [
        'fi' => 'Valitse näytön ajolista',
        'sv' => 'Välj skärmens spellista',
        'en' => 'Select display playlist',
        'it' => 'Seleziona la playlist del display',
        'el' => 'Επιλέξτε λίστα αναπαραγωγής οθόνης',
    ],
    'btn_playlist_prev' => [
        'fi' => 'Edellinen',
        'sv' => 'Föregående',
...
'GRID_SELECT_HINT' => [
    ...
    'playlist_loading' => [
        'fi' => 'Ladataan ajolistaa…',
        'sv' => 'Laddar spellista…',
        'en' => 'Loading playlist…',
        'it' => 'Caricamento playlist…',
        'el' => 'Φόρτωση λίστας…',
    ],
...
'btn_republish_to_displays' => [
    'fi' => 'Julkaise uudelleen',
    'sv' => 'Publicera igen',
    'en' => 'Republish',
    'it' => 'Ripubblica',
    'el' => 'Επαναδημοσίευση',
],
	    'playlist_duration_label' => [
        'fi' => 'Näyttöaika',
        'sv' => 'Visningstid',
        'en' => 'Display time',
        'it' => 'Tempo di visualizzazione',
...
'publish_display_targets_help' => [
    'fi' => 'Valitse infonäytöt, joille tämä kieliversio julkaistaan.',
    'sv' => 'Välj de informationsskärmar där denna språkversion publiceras.',
    'en' => 'Select the displays where this language version will be published.',
    'it' => 'Seleziona gli schermi su cui pubblicare questa versione linguistica.',
    'el' => 'Επιλέξτε τις οθόνες στις οποίες θα δημοσιευτεί αυτή η γλωσσική έκδοση.',
],
'display_targets_auto_filter_note' => [
    'fi' => 'Näytetään vain tämän kieliversion infonäytöt.',
    'sv' => 'Endast informationsskärmar för denna språkversion visas.',
    'en' => 'Only displays for this language version are shown.',
    'it' => 'Vengono mostrati solo gli schermi per questa versione linguistica.',
    'el' => 'Εμφανίζονται μόνο οι οθόνες για αυτή τη γλωσσική έκδοση.',
],
    'display_targets_no_allowed_for_language' => [
        'fi' => 'Tälle kieliversiolle ei löytynyt sallittuja infonäyttöjä. Tarkista työmaiden maa- ja kieliasetukset.',
        'sv' => 'Inga tillåtna informationsskärmar hittades för denna språkversion. Kontrollera arbetsplatsernas land- och språkinställningar.',
        'en' => 'No allowed displays were found for this language version. Check the country and language settings of the worksites.',
        'it' => 'Non sono stati trovati schermi consentiti per questa versione linguistica. Controlla le impostazioni del paese e delle lingue dei siti.',
        'el' => 'Δεν βρέθηκαν επιτρεπόμενες οθόνες για αυτή τη γλωσσική έκδοση. Ελέγξτε τις ρυθμίσεις χώρας και γλώσσας των εργοταξίων.',
    ],
];